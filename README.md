...
نتایج زیر مربوط به اجرای ثبت‌شدهٔ اصلاحات کد هستند. در بازبینی مستندات، گزارش‌های موجود Surefire جمعاً ۱۹۱ تست موفق را تأیید کردند؛ تست‌های بک‌اند در این بازبینی دوباره اجرا نشدند.

| دستور | نتیجهٔ آخرین اجرا |
|---|---|
| `cd foody-backend && mvn test` | ۱۹۱ تست، بدون failure/error/skip؛ شامل Testcontainers با MySQL 8.4 |
...
- [ ] حفاظت از تغییر همزمان وضعیت سفارش، رزرو و کسب‌وکار. دلیل: جلوگیری از بازنویسی وضعیت و اعلان‌های متناقض.
...
- [x] Flyway migrations از V1 تا V10 (هسته، سفارش، رزرو، اعلان، کیف پول و پروفایل/مختصات کاربر)
