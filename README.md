...
تست‌های جدید شامل ۱۲ حالت پارامتری احراز هویت، ۳ تست واحد عدم صدور توکن و ۹ حالت یکپارچهٔ حریم خصوصی/مالکیت رزرو هستند. تست‌های standalone کنترلر جایگزین تست زنجیرهٔ واقعی امنیت نیستند. تست اختصاصی کیف پول و تست خودکار فرانت‌اند هنوز اضافه نشده‌اند.
...
- [ ] اصلاح مدیریت نشست فرانت‌اند و پردازش خطاهای خالی/غیر JSON در `lib/api.ts`؛ پاک‌سازی هماهنگ کاربر و cache پس از شکست احراز هویت. دلیل: خطای بازیابی نشست و احتمال نمایش دادهٔ حساب قبلی. **تسک کدنویسی بعدی پیشنهادی**.
