...
### 📝 راهنمای استفاده از این چک‌لیست
هر وقت یک فیچر رو کامل کردیم و پوش کردیم روی GitHub، باکس مربوطه از `[ ]` به `[x]` تغییر می‌کنه. این فایل رو می‌تونی مستقیم به‌عنوان `README.md` در ریشه‌ی ریپازیتوری قرار بدی.
