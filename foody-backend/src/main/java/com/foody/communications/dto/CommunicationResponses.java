...
public final class CommunicationResponses {private CommunicationResponses(){}
 public record TicketSummary(Long id,TicketRequesterType requesterType,Long businessId,String businessName,String requesterDisplayName,String requesterPublicId,String subject,TicketStatus status,boolean unread,Instant createdAt,Instant updatedAt){}
